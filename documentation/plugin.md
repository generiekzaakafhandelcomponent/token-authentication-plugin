...
This is a Token Authentication Plugin demonstrating an API call action. It fetches data from a time API endpoint.
...
```kotlin
dependencies {
    implementation("com.ritense.valtimoplugins:token-authentication:0.0.1")
}
```
...
{
  "dependencies": {
    "@valtimo-plugins/token-authentication": "0.0.1"
  }
}
```
...
} from '@valtimo-plugins/token-authentication';
